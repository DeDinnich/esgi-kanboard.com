<div class="container-fluid">
        <div class="row row-cols-1 row-cols-md-4 g-3">
                                    ...
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <div class="ms-auto dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><form method="POST" action="{{ route('tasks.destroy', $task) }}">@csrf @method('DELETE')<button type="submit" class="dropdown-item text-danger">Supprimer</button></form></li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            @empty
                <div class="col-12">
                    <div class="alert alert-warning text-center">Aucun tableau n’a été créé pour ce projet.</div>
                </div>
            @endforelse

            <div class="col">
                <div class="card h-100 d-flex justify-content-center align-items-center p-3 border border-dashed border-primary text-center" style="min-height: 200px;">
